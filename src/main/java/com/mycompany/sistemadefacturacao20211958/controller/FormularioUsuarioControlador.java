...
import com.mycompany.sistemadefacturacao20211958.models.entidades.Permissao;
import com.mycompany.sistemadefacturacao20211958.models.entidades.PermissaoUsuario;
import com.mycompany.sistemadefacturacao20211958.models.entidades.Usuario;
import com.mycompany.sistemadefacturacao20211958.models.services.PermissaoServico;
import com.mycompany.sistemadefacturacao20211958.models.services.UsuarioServico;
import com.mycompany.sistemadefacturacao20211958.view.formulario.FormularioUsuario;
import com.mycompany.sistemadefacturacao20211958.view.modelos.UsuarioTabelaModelo;
...
public final class FormularioUsuarioControlador implements ActionListener, KeyListener {
    ...
    private UsuarioTabelaModelo usuarioModelo;
    ...
    private void preencherValoresNaTabela() {
        usuarioModelo = new UsuarioTabelaModelo(this.usuarios);
    ...
    private void validaComboBox() {
        if (formularioUsuario.getComboboxPerfil().getSelectedIndex() < 1) {
            String mensagem  = "É Obrigatório Selecionar o Perfil";
            formularioUsuario.getLabelMensagem().setText(mensagem);
            corDeMensagemDeErro();
            throw new RuntimeException(mensagem);
        }
    ...
    private void salvar() {
        ...
        String email = formularioUsuario.getTextoUsuario().getText();
    ...
    private void limpa() {
        ...
        formularioUsuario.getTextoUsuario().setText("");
    ...
    private void preencher(Usuario usuario) {
        ...
        formularioUsuario.getTextoUsuario().setText(usuario.getUsuario());
        formularioUsuario.getTextoSenha().setText("");
    ...
    private void permissaoSalvar() {
        ...
        var filtroSalva = adicionaPermissao.stream()
                .filter(pu -> !permissaoServico.validaPermissoes(pu.getIdUsuario(), pu.getIdPermissao()))
        ...
        removePermissao.stream()
                .filter(pu -> permissaoServico.validaPermissoes(pu.getIdUsuario(), pu.getIdPermissao()))
                .forEach(pu -> permissaoServico.delete(pu.getIdUsuario(), pu.getIdPermissao()));
